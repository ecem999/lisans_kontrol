...
COUNTRIES_CONFIG = {
    ...
    "spain": {
        "license_format": r"^(GT|CE|GI|APIT|RG|GA|GC|CLM|CL)-?\d{3,7}-?[A-Z]{0,2}$", 
...
STATUS_MAP = {
    "VALID": {"label": "Yüksek İhtimalle Doğru", "color": "green"},
    "UNKNOWN": {"label": "Doğruluğu Kesinleştirilemedi", "color": "yellow"},
    "INVALID": {"label": "Yüksek İhtimalle Hatalı", "color": "red"}
}
